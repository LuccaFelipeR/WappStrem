...
const Player = ({
    ...
    const removeMovie = async (duration) => {
        ...
        if (type === "series") {
            ...
            try {
                await removeMovieFromRecents(id, 'Movie', user.dbAddress);
            } catch (error) {
                console.log(error)
            }
            // changeOrientation("unlock")
        ...
        if (time > 10) {
            ...
            if (type !== 'm3u') {
                if (type === "series") {
                    ...
                    try {
                      return  await saveWatchedContent.movie(id, user.dbAddress, {
                            timeline: time,
    ...
    const handleAddToFav = async () => {
        ...
        try {
            if (isFavourite) {
                await removeFromFavs(id, type === 'movies' ? 'Movie' : 'Series', user.dbAddress);
                alert.toggle({
                    show: true,
                ...
                await addToFavs(id, type === 'movies' ? 'Movie' : 'Series', user.dbAddress);
                alert.toggle({
                    show: true,
        ...
        <div
            ...
            <VideoJs
                ...
                options={{
                    ...
                    // ],
                    sources: [{
                        src: "http://nubiatv.live/movie/Abel57/222333/1024257.mp4",
                        type: 'video/mp4'
                    }]
                }}
            />
                ...
                videoLoaded ?
                    <>
                        <div className={
                            ...
                            <img alt="placeholder" onClick={handleSeek.back} src={seekBack} />
                            <img alt="placeholder" onClick={handleSeek.playPause} src={!playActive ? playBtn : pauseBtn} />
                             <img alt="placeholder" onClick={handleSeek.forward} src={seekForward} />
                        </div>
                        <p style={{
                            position: 'absolute',
                        ...
                        <div className={`${controlsActive ? "bottom-options" : "bottom-options-notShow"}`}>
                            {type === "series" && <div ref={episodeOptionRef} onClick={() => {
                                ...
                                <img alt="placeholder" src={episodesIcon} />
                            ...
                            </div>
                            {
                                ...
                                <div onClick={handleNextEpisode} className="option">
                                    <img alt="placeholder" src={nextEpisode} />
