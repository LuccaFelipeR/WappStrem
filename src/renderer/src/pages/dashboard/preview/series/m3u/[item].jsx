...
const SeriesPreviewM3u = () => {
    ...
    // const { item, id, stream } = query;Fuse
    ...
    const getMovieTimeline = async () => {
        const streamId = id;
        try {
            const response = await getParticluarTimeline(concatUrl(streamUrl), 'Series', finalAddress);
            if (response.val()) {
...
export default SeriesPreviewM3u;